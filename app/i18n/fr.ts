...
const fr: Translations = {
  walkthroughScreen: {
    slides: {
      slide1: {
        title: "Votre service d'abonnement automobile ultime",
        description: "Conduisez ce que vous voulez, quand vous voulez... sans les engagements à long terme ou les nombreuses responsabilités et coûts de possession d'une automobile."
      },
      slide2: {
        title: "Comment ça fonctionne - Simple, Flexible et Pratique",
        description: "Parcourez notre réseau étendu. Décidez de la durée et du kilométrage. Nous livrerons à votre porte. Assurance, entretien, assistance routière inclus."
      },
      slide3: {
        title: "Pourquoi AutoSeraph ?",
        description: "Changez de voiture ou annulez à tout moment... payez uniquement ce dont vous avez besoin, quand vous en avez besoin. Accédez à des voitures économiques jusqu'aux SUV de luxe provenant des fournisseurs les plus réputés."
      }
