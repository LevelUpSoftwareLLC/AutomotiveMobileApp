...
const ar: Translations = {
  walkthroughScreen: {
    slides: {
      slide1: {
        title: 'خدمة الاشتراك في السيارات الشاملة',
        description: 'قُد ما تريد، متى تريد... دون التزامات طويلة الأمد أو العديد من المسؤوليات والتكاليف المرتبطة بملكية السيارات.',
      },
      slide2: {
        title: 'كيف يعمل - بسيط، مرن، ومريح',
        description: "تصفح شبكتنا الواسعة، قرر المدة والمسافة المقطوعة. سنقوم بالتوصيل إلى باب منزلك. التأمين، الصيانة، والمساعدة على الطريق مشمولة.",
      },
      slide3: {
        title: 'لماذا AutoSeraph؟',
        description: "غيّر السيارات أو الغِ الاشتراك في أي وقت... ادفع مقابل ما تحتاجه عندما تحتاجه. احصل على الوصول إلى سيارات الاقتصادية وحتى السيارات الفاخرة من مزودين ذوي سمعة طيبة.",
      },
