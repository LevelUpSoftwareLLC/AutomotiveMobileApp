...
const ko: Translations = {
  walkthroughScreen: {
    slides: {
      slide1: {
        title: '당신의 궁극적인 차량 구독 서비스',
        description: '원하는 차를 원할 때마다 운전하세요... 장기 약정이나 자동차 소유의 수많은 책임과 비용 없이.',
      },
      slide2: {
        title: '작동 방식 - 간단하고, 유연하며, 편리합니다',
        description: "우리의 광범위한 네트워크를 탐색하십시오. 사용 기간과 주행 거리를 결정하세요. 우리가 당신의 문앞까지 배송해 드립니다. 보험, 정비, 도로변 지원이 포함되어 있습니다.",
      },
      slide3: {
        title: '왜 AutoSeraph인가요?',
        description: '언제든지 차량을 변경하거나 취소하세요... 필요할 때 필요한 것만 지불하세요. 가장 신뢰할 수 있는 제공업체에서 경제적인 차량부터 고급 SUV까지 이용할 수 있습니다.',
      },
